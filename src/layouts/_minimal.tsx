...
export function Header() {
  ...
  return (
    <nav
      className={cn(
        'fixed top-0 z-30 flex w-full items-center justify-between px-4 transition-all duration-300 ltr:right-0 rtl:left-0 sm:px-6 lg:px-8 3xl:px-10',
...
export default function MinimalLayout({
  ...
  return (
    <div className="bg-light-100 dark:bg-dark-100 mt-8 flex min-h-screen flex-col gap-6 px-4 sm:px-6 lg:px-8 3xl:px-10">
      <Header />
      <main className="mx-auto mb-12 flex w-full max-w-[2160px] flex-grow flex-col pt-16 sm:pt-24">
        {children}
      </main>
    </div>
  );
