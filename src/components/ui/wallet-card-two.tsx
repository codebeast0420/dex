...
export default function WalletCard() {
  ...
  return (
    <div className="rounded-lg bg-transparent  dark:bg-light-dark ">
      ...
      <div className="relative flex h-[290px] justify-center">
        ...
        <div className="absolute left-2/4 top-2/4 flex h-[156px]  w-[156px] -translate-x-2/4 -translate-y-2/4 transform  items-center  justify-center rounded-full border border-dashed border-gray-400 bg-gray-50 dark:border-gray-600 dark:bg-gray-900 md:h-32 md:w-32 xl:h-[156px] xl:w-[156px]">
          <span
            className={cn(
